  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        <a class="navbar-brand brand-logo" href="index.html"><h3>Data Dosen</h3></a>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="export_dosen.php" class="btn btn-success">
                      ...
                      <form method="GET" action="">
                        <div class="row">
                          <div class="col-md-6" style="padding-right: 15px;">
                            <input type="text" name="nama" class="form-control" placeholder="Cari Nama Dosen">
                          </div>
                          <div class="col-md-6" style="padding-left: 15px;">
                            <button type="submit" class="btn btn-primary" style="margin-right: 8px;">Tampilkan</button>
                            <a href="data dosen.php" class="btn btn-secondary">Reset</a>
                          </div>
                        </div>
                      </form>
                    </div>
                  ...
                  <h4 class="card-title">Tabel dim_dosen</h4>
                      ...
                      <tbody>
                        ...
                        <?php
                          ...
                          if(isset($_GET['nama']) && $_GET['nama'] != ""){
                            $nama = $_GET['nama'];
                            $sql = "SELECT * FROM dim_dosen WHERE nama_dosen LIKE '%$nama%'";
                          }
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="edit_dosen.php?id=<?php echo $d['id_dosen']; ?>" class="badge badge-gradient-info">Edit</a>
                            <a href="hapus_dosen.php?id=<?php echo $d['id_dosen']; ?>" class="badge badge-gradient-danger" onclick="return confirm('Yakin hapus?')">Hapus</a>
                          </td>
                        </tr>
      ...
      <div class="modal-content">
        <div class="modal-header bg-gradient-primary text-white">
          <h5 class="modal-title">
            <i class="mdi mdi-plus-circle"></i> Tambah Data Dosen
          </h5>
        ...
        <div class="modal-body">
          <form action="simpan_dosen.php" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" name="id_dosen" class="form-control" placeholder="Masukkan ID Dosen" required>
            </div>
